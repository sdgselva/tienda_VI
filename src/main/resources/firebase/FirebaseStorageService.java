...
public class FirebaseStorageService {
    ...
    final String BucketName = "tienda-sol-gutierrez.firebasestorage.app";
    ...
    final String archivoJsonFile = "tienda-sol-gutierrez-firebase-adminsdk-fbsvc-6911edcf8e"+".json";
